...
var SelectionModel = class {
  ...
  changed = new import_rxjs6.Subject();
...
var FixedSizeVirtualScrollStrategy = class {
  _scrolledIndexChange = new import_rxjs7.Subject();
  /** @docs-private Implemented as part of VirtualScrollStrategy. */
  scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators5.distinctUntilChanged)());
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs7.Subject();
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators5.filter)((target) => !target || ancestors.indexOf(target) > -1));
  }
...
var CdkScrollable = class _CdkScrollable {
  ...
  _destroyed = new import_rxjs7.Subject();
  _renderer = inject(Renderer2);
  _cleanupScroll;
  _elementScrolled = new import_rxjs7.Subject();
  constructor() {
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  ...
  _change = new import_rxjs7.Subject();
  /** Used to reference correct document/window */
  _document = inject(DOCUMENT, {
    optional: true
  });
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _detachedSubject = new import_rxjs7.Subject();
  /** Emits when the rendered range changes. */
  _renderedRangeSubject = new import_rxjs7.Subject();
  ...
  scrolledIndexChange = new import_rxjs7.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  ...
  _viewportChanges = import_rxjs7.Subscription.EMPTY;
  _injector = inject(Injector);
  _isDestroyed = false;
  constructor() {
    super();
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs7.Subject();
  /** Subject that emits when a new DataSource instance is given. */
  _dataSourceChanges = new import_rxjs7.Subject();
...
//# sourceMappingURL=chunk-USVJKT62.js.map
