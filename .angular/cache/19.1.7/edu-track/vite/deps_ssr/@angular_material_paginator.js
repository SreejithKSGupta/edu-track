...
var SingleBoxSharedResizeObserver = class {
  ...
  _resizeSubject = new import_rxjs2.Subject();
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  _resizeSubscription = new import_rxjs3.Subscription();
  constructor() {
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control.stateChanges.pipe((0, import_operators3.startWith)([void 0, void 0]), (0, import_operators3.map)(() => [control.errorState, control.userAriaDescribedBy]), (0, import_operators3.pairwise)(), (0, import_operators3.filter)(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
      return prevErrorState !== currentErrorState || prevDescribedBy !== currentDescribedBy;
    })).subscribe(() => this._syncDescribedByIds());
    this._valueChanges?.unsubscribe();
    if (control.ngControl && control.ngControl.valueChanges) {
      this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _initializeOutlineLabelOffsetSubscriptions() {
    ...
    this._dir.change.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => this._needsOutlineLabelOffsetUpdate = true);
  }
...
function toObservable(value) {
  const obs = isPromise(value) ? (0, import_rxjs4.from)(value) : value;
...
function composeAsync(validators) {
  ...
  return function(control) {
    ...
    return (0, import_rxjs4.forkJoin)(observables).pipe((0, import_operators4.map)(mergeErrors));
  };
}
...
var AbstractControl = class {
   ...
   * @internal
   */
  _events = new import_rxjs4.Subject();
  /**
...
var MatSelect = class _MatSelect {
  ...
  _panelDoneAnimatingStream = new import_rxjs5.Subject();
  ...
  optionSelectionChanges = (0, import_rxjs5.defer)(() => {
    ...
    if (options) {
      return options.changes.pipe((0, import_operators5.startWith)(options), (0, import_operators5.switchMap)(() => (0, import_rxjs5.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _openedStream = this.openedChange.pipe((0, import_operators5.filter)((o) => o), (0, import_operators5.map)(() => {
  }));
  /** Event emitted when the select has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators5.filter)((o) => !o), (0, import_operators5.map)(() => {
  }));
  ...
  _resetOptions() {
    ...
    (0, import_rxjs5.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators5.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
var MatTooltip = class _MatTooltip {
  ...
  _createOverlay(origin) {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators6.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
